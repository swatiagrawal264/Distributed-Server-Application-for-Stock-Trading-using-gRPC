...
# Order Host and Port Defined
TRADES_HOST = 'localhost'
TRADES_PORT = 8002
# Catalogue Host and Port Defined  
STOCKS_HOST = 'localhost'
STOCKS_PORT = 8001

# Front End Host and Port Defined for sending and receiving Http requests
HOST = '10.0.0.141'
PORT = 9999

# Here we will define do_GET and do_Post functions to send and receive requests
